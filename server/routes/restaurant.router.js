...
router.get('/all', (req, res) => {
    ...
    let queryText = `SELECT "restaurant"."id", "restaurant", "menu_url", "image", "address", "phone_number", "delivers", "reservation", "price_id", "price" FROM "restaurant" JOIN "price" ON "price"."id" = "restaurant"."price_id" ORDER BY "restaurant" ASC;`
